...
def plotCorrelations (cMatrix, x_label, y_label, plotName, x_labels, y_labels):
	...
	title = 'Correlation Matrix for ASD ' + plotName[-5]
	plt.title(title)
	#sns.plt.show()
	#fig = ax.get_figure()
...
for subject in listOfSubjects:
	...
	print EEGFeatureNames
	print EEGFeatures

	print audioFeatureNames
	...
	print 'Maximum correlations between audio features and EEG features for Subject '+ subject[3] +':'
	...
	### HEATMAPS ###
	plotCorrelations (cMatrix = abs_corrMatrix[0][:,:], x_label = 'EEG features', y_label = 'Audio features', plotName = path + 'CorrelationMatrixA/' + 'Correlation_Matrix_'+ subject[3] +'.png', x_labels = EEGFeatureNames, y_labels = audioFeatureNames)

#AverageMatrixCorrelation = AverageMatrixCorrelation/3
#plotCorrelations (cMatrix = AverageMatrixCorrelation, x_label = 'EEG features', y_label = 'Audio features', plotName = path + 'CorrelationMatrix/' + 'AverageCorrelation_Matrix_'+'.png', x_labels = EEGFeatureNames, y_labels = audioFeatureNames)
