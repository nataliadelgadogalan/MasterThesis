...
listOfSubjects = listdir(path + 'DataASD/')
...
for subject in listOfSubjects:
	...
	for stimuli_class in listOfStimuliClass:
		...
		if int(stimuli_class[10]) == 2: averageConfMatrix_visual = averageConfMatrix_visual + confMatrix
		if int(stimuli_class[10]) == 3: averageConfMatrix_AV_C = averageConfMatrix_AV_C + confMatrix
		if int(stimuli_class[10]) == 4: averageConfMatrix_AV_NC_A = averageConfMatrix_AV_NC_A + confMatrix
		if int(stimuli_class[10]) == 5: averageConfMatrix_AV_NC_V = averageConfMatrix_AV_NC_V + confMatrix
