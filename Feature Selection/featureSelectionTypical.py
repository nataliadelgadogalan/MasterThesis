...
n_audiofeatures = 3
output_name = 'SelectedFeatures_ASD.csv'
...
for video in listOfVideos:
	...
	listOfEEGFiles = listdir(path + 'EEGFeaturesTypical/' + video + '/')
	...
	for file in listOfFeatures:
		...
		for EEGfile in listOfEEGFiles:
			...
			print 'eegFile:'
			print EEGfile
			EEGFeature_names, eeg_feature = readfile(path + 'EEGFeaturesTypical/' + video + '/' + EEGfile)
